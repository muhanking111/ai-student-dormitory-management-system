...
const backendEnv = {
  ...
  // Stage 4 proves preview/guard rendering only; it must never execute a
  // business write as part of screenshot generation.
  AI_WRITE_EXECUTION_ENABLED: 'false',
  AI_ROLLOUT_ENABLED: 'true',
  AI_ROLLOUT_BASIS_POINTS: '10000',
  AI_ROLLOUT_POLICY_VERSION: 'ai-live-stage4-rollout-v1',
  AI_ROLLOUT_HMAC_KEY: 'ai-live-stage4-rollout-key-with-at-least-32-bytes',
  AI_AUDIT_HMAC_KEY: 'ai-live-stage4-audit-integrity-key-v1-20260720',
  AI_TOKENIZATION_HMAC_KEY: 'ai-live-stage4-tokenization-key-v1-20260720',
  AI_STEP_UP_HMAC_KEY: 'ai-live-stage4-step-up-proof-key-v1-20260720',
...
export default defineConfig({
  testDir: './e2e',
  testMatch: 'ai-live-stage4.spec.ts',
  ...
  retries: 0,
  reporter: 'line',
  outputDir: 'test-results/ai-live-stage4-run',
  use: {
  ...
  webServer: [
    {
      ...
      env: backendEnv,
      // A stage-specific port must never silently attach to another server.
  ...
  projects: [
    { name: 'ai-live-stage4-chromium', use: { ...devices['Desktop Chrome'] } },
  ],
})
